...
void testSchedulerSJF(void){  //FCFS or RR or SJF or PRIORITY0
	tskPara tskParas[4];
	int i;

	if(getSysScheduler()!=SCHEDULER_SJF) {
		myPrintf(0x3,"NEED scheduler: SCHEDULER_SJF!!!!!!STOPED!!!!!!!!");
		return;
	}
